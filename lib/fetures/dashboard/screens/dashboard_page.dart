      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            child: Text(
            controller.user?.ownwerName ?? 'Không có dữ liệu',
          ...
          InkWell(
            ...
            child: Hero(
              ...
              child: Container(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(100),
                  child: controller.user == null || controller.user!.profilePictuer.isEmpty
                      ? const Icon(
                    Icons.person, // Biểu tượng mặc định nếu không có hình
                    size: 24,
                  )
                      : CachedNetworkImage(
                    ...
                    errorWidget: (context, url, error) => const Icon(
                      Icons.error, // Biểu tượng lỗi nếu không tải được hình
                      size: 24,
                    ),
